...
map.getView().fit([-512150.263029, 995894.090945, 241023.976590, 1713478.361131], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">REGION DU BURKINA</h2>';
        return titleElement;
    })(),
